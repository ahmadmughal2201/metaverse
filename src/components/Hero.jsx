...
const Hero = () => {
  return (
    <div className='sm:py-16 xs:py-8 py-12 p-20 sm:pl-16 pl-6'>
      <motion.div variants={staggerContainer}
        initial='hidden' whileInView='show' viewport={{ once: false, amount: 0.25 }} className="lg:w-[80%] w-[100%] mx-auto flex flex-col">
...
<motion.div variants={textVariant(1.2)} className='flex justify-center items-center flex-row'>
        ...
        <motion.div variants={slideIn('right','tween',0.2,1)} className='relative w-full md:-mt-[20px] -mt-[12px]'>
          ...
          <div className='w-full flex justify-end sm:-mt-[70px] -mt-[50px] pr-[40px] relative z-10'>
            <img src='/stamp.png' className='sm:w-[155px] sm:h-[155px] w-[100px] h-[100px] object-contain'/>
          </div>
          </a>
